...
void drawONButton() {
  ...
  switch (runCycle) {
    ...
    case 14:
      tft.drawString("ON", ONBUTTON_X + (ONBUTTON_W / 2), ONBUTTON_Y + (ONBUTTON_H / 2));
      tft.drawString("1,2,3,..", Info_X + (Info_W / 2), Info_Y + (Info_H / 2));
      break;
    case 15:
      tft.drawString("ON", ONBUTTON_X + (ONBUTTON_W / 2), ONBUTTON_Y + (ONBUTTON_H / 2));
      tft.drawString("Man,..", Info_X + (Info_W / 2), Info_Y + (Info_H / 2));
      break;
    default:
      tft.drawString("OFF", ONBUTTON_X + (ONBUTTON_W / 2), ONBUTTON_Y + (ONBUTTON_H / 2));
      tft.drawString(" ", Info_X + (Info_W / 2), Info_Y + (Info_H / 2));
...
void drawButtonsScreenOne() {
  ...
  tft.drawString("123", SixBUTTON_X + (SixBUTTON_W / 2), SixBUTTON_Y + (50 / 2));
  tft.drawString("M12", SevenBUTTON_X + (SevenBUTTON_W / 2), SevenBUTTON_Y + (50 / 2));
